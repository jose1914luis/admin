<?php
	...
	if($_POST["tipo_servicio"]>3)
		$mensaje = '	
			...
			<p>Para acceder directamente al servicio <b>"'.($_POST["descripcion_servicio"]).'"</b> haga click en <a href="http://www.sigmin.co/services/?codacceso='.$_POST["codigo_acceso"].'" style="text-decoration:none;color:white;background:green" target="_top">&nbsp;&nbsp;ACCESO AL SERVICIO&nbsp;&nbsp;</a></p>
			
			<p>Tambi&eacute;n puede ingresar a trav&eacute;s del enlace <b><a href="http://www.sigmin.co/services/" style="text-decoration:none;" target="_top">Sigmin FINDER</a></b></p>
			<p> RECUERDE: <br>Su usuario (username) de acceso al sistema es: <i><u>'.$_POST["email"].'</u></i>
			<br>Su clave de acceso (passwd) es: <i><u>'.$_POST["codigo_acceso"].'</u></i></p>
	...
	$msg = enviar_email("www.sigmin.com.co", $listaEmails, "Ingreso a Servicios :: SIGMIN", $mensaje);
